...
In addition to the paper describing the dataset ([Aung et al 2016](https://ieeexplore.ieee.org/abstract/document/7173007)) mentioned in the EULA, please refer to the [baseline paper](https://arxiv.org/pdf/2001.07739v1.pdf) describing the features extraction methods used in the three tasks (as described above) and the baselines for this challenge. This paper should be cited in the challenge camera ready paper.
<br>
